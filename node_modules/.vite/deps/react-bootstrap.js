import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-O5AEX3BC.js";
import {
  ButtonGroup_default
} from "./chunk-2BSAQOUY.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
...
import {
  ...
  require_warning,
  useCol
} from "./chunk-SHYSBFD5.js";
import {
  createWithBsPrefix,
  require_prop_types
} from "./chunk-PBXXDPEZ.js";
import {
  Table_default
} from "./chunk-WTYRG4P3.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react20.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useForceUpdate() {
  var _useReducer = (0, import_react21.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react22.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react26.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react26.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react26.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react26.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var SelectableContext = React26.createContext(null);
...
var NavContext = React27.createContext(null);
...
var Container = React38.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var FigureImage = React40.forwardRef(({
  className,
  fluid = true,
  ...props
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime37.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime37.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime37.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime37.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime37.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime37.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames25.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var NavItem = React43.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime38.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React44.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime39.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime39.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime39.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var ListGroupItem = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime40.jsx)(Component2, {
    ...
    ...navItemProps,
    onClick: handleClick,
    className: (0, import_classnames26.default)(className, bsPrefix, meta.isActive && "active", disabled && "disabled", variant && `${bsPrefix}-${variant}`, action && `${bsPrefix}-action`)
  });
});
...
var ListGroup = React46.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime41.jsx)(Nav_default, {
    ...
    ...controlledProps,
    as,
    className: (0, import_classnames27.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, numbered && `${bsPrefix}-numbered`)
  });
});
...
var NavLink = React47.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime42.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames28.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React48.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  return (0, import_jsx_runtime43.jsx)(Nav_default, {
    ...
    ref,
    activeKey,
    className: (0, import_classnames29.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavbarBrand = React49.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React50.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context6 = (0, import_react38.useContext)(NavbarContext_default);
...
var NavbarToggle = React51.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime46.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames31.default)(className, bsPrefix, !expanded && "collapsed"),
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react41.useMemo)(function() {
...
var OffcanvasToggling = React52.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime47.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React52.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames32.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React53.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime49.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React54.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react42.useCallback)((backdropProps) => (0, import_jsx_runtime49.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames34.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime49.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames34.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime51.jsxs)(import_jsx_runtime50.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime49.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React55.forwardRef((props, ref) => {
  const context6 = (0, import_react43.useContext)(NavbarContext_default);
...
var Navbar = React56.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  return (0, import_jsx_runtime53.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime53.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime53.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames35.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, navItemPrefix),
...
var Popover = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsxs)("div", {
    ...
    className: (0, import_classnames37.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Overlay2 = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React61.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames38.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react49.cloneElement)(children, triggerProps), (0, import_jsx_runtime59.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames39.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime63.jsxs)(Component2, {
      className: "page-link",
      ...props,
...
var Pagination = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime64.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames40.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames41.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React65.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime65.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime67.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames42.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime67.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var Ratio = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime68.jsx)("div", {
    ...
    className: (0, import_classnames43.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React69.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames44.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React70.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames45.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var Stack = React72.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames46.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react51.useContext)(TabContext_default);
  if (!context6)
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime79.jsx)(import_jsx_runtime78.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime80.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React79.forwardRef((props, ref) => (0, import_jsx_runtime82.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React80.createContext({
...
var ToastHeader = React81.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context6 = (0, import_react53.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastContainer = React83.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React84.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React85.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
...
var Tooltip = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames52.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
